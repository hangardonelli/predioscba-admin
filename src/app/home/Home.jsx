...
const Home = () => {
  ...
  const pay = async (e, predioUserId, userId) => {
      ...
      swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
          ...
          if (pay.status === 200) {
            ...
            swalWithBootstrapButtons.fire(
              'Pagado!',
              'El monto ingresado fue descontado del balance del predio.',
              'success'
            )
          }
        } else if (
                  ...
                  <tbody>
                    {listPredios.map((predioItem, p) => (
                      <tr key={p}>
                        ...
                        <td>
                          <Button variant="primary" onClick={() => showTurnosFee(predioItem._id)}>
                            $ {predioItem.account ? predioItem.account.balance : 0}
                          </Button> 
                        </td>
                        <td> 
                          <button 
                            ...
                            onClick={(e) => pay(e, predioItem.userId, user._id)}>Nuevo Pago</button>
                        </td>
                        <td>
                          <button 
                            type="button" 
